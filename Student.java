...
public class Student extends Common_function {
    ...
    void giveFeedback() {
        ...
        System.out.print("Enter Course code you want to Rate and give feedback : ");
        code = sc.next();
        System.out.print("Enter rating for the Course : ");
        rating = sc.nextInt();
        System.out.println("Enter textual feedback for rating : ");
        sc.nextLine();
        textfeedback = sc.nextLine();

        try {
            Connection con = DBConnection.getConnection();
            PreparedStatement pstmt = con.prepareStatement("insert into feedback (Course,Rating,Text) values (?,?,?)");
            pstmt.setString(1, code);
            pstmt.setInt(2, rating);
            pstmt.setString(3, textfeedback);
            ...
            if (result > 0) {
                ...
                System.out.println("---------------------------------------------------");
                System.out.println("Error occured while submiting the feedback");
                System.out.println("---------------------------------------------------");
            }
